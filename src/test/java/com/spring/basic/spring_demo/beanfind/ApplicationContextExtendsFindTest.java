package com.spring.basic.spring_demo.beanfind;
...
public class ApplicationContextExtendsFindTest {
    ...
    void findBeanByParentTypeBeanName() {
        DiscountPolicy rateDiscountPolcy = ac.getBean("rateDiscountPolicy", DiscountPolicy.class);
        assertThat(rateDiscountPolcy).isInstanceOf(RateDiscountPolicy.class);
    }
